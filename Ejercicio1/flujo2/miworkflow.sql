...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-06-2023 a las 06:14:40
...
('F2', 'P1', 'P2', 'I', 'Alumno', 'inicial2'),
('F2', 'P2', 'P3', 'P', 'Alumno', 'datos2'),
('F2', 'P3', 'P4', 'P', 'Alumno', 'envio2'),
('F2', 'P4', NULL, 'C', 'Kardex', 'revision2'),
('F2', 'P5', 'P2', 'P', 'Kardex', 'no2'),
('F2', 'P6', 'P7', 'P', 'Kardex', 'si2'),
('F2', 'P7', NULL, 'F', 'Alumno', 'inscripcion');
...
--
-- Estructura de tabla para la tabla `flujodescripcion`
--

CREATE TABLE `flujodescripcion` (
  `flujo` varchar(10) DEFAULT NULL,
  `descipcion` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `flujodescripcion`
--

INSERT INTO `flujodescripcion` (`flujo`, `descipcion`) VALUES
('F1', 'Certificado de conclusión'),
('F2', 'Nueva inscripción');
